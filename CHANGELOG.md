...
## 1.2.5
Android video rendering supports mixed integration mode. The default mode is virtual display mode. The viewmode of trtcloudvideoview is transmitted to trtclouddef TRTC_ VideoView_ Model_ Hybrid
## 1.2.4
...
## 0.2.2
TRTC shuttle SDK removes the path_ Provider dependency
## 0.2.1
